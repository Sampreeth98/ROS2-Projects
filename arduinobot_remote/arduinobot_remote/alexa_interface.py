...
class WakeIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speech_text = "Hello, Welcome back, Lets get started"
...
skill_adapter = SkillAdapter(
    skill=skill_builder.create(), skill_id="amzn1.ask.skill.2deaf869-aab6-4b5f-b080-c99cd21afda1", app=app)
